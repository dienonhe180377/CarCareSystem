...
<head>
    ...
    <style>
        ...
        .container { max-width: 900px; margin: 24px auto; padding: 24px; background: #fff; border-radius: 10px; box-shadow: 0 2px 16px #e5eaf2;}
        h2 { color: #003366; text-align: center; margin-top: 0;}
        table { border-collapse: collapse; width: 100%; margin-top: 18px;}
        th, td { border: 1px solid #d5dae3; padding: 10px 8px;}
        th { background: #f1f5fc; text-align: left; color: #0e2147;}
        h3 { color: #1b4882; margin-bottom: 0; margin-top: 32px;}
        .total { color: #e53935; font-weight: bold; font-size: 1.08em;}
        .label { font-weight: bold; }
        .service-row { background: #fbfcff; }
        .parts-list { color: #1b4882; font-size: 0.98em;}
        .back-link {display:inline-block;margin-top:28px;background:#e3eaf7;color:#1b4882;padding:8px 18px;text-decoration:none;border-radius:5px;transition:background .2s;}
        .back-link:hover {background:#c9dafc;}
