...
<head>
    ...
    <style>
        ...
        .container { max-width: 900px; margin: 28px auto; padding: 28px; background: #fff; border-radius: 10px; box-shadow: 0 2px 12px #e5eaf2;}
        h2 { color: #003366; text-align: center; margin-top: 0;}
        table { border-collapse: collapse; width: 100%; margin-top: 20px;}
        th, td { border: 1px solid #d5dae3; padding: 10px;}
